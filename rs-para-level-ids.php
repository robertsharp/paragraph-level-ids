...
function rs_para_ids_options() { ?>
    ...
    <div class="wrap">
        ...
        <?php settings_fields('rs_para_ids_optiongroup'); ?>
            ...
            <p>Enable this section to add # links immediately after each paragraph tag in your content. This will enable readers to quickly share a section of your article.</p>
